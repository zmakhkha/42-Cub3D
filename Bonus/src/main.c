...
/*   Updated: 2023/08/05 11:19:07 by zmakhkha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_minimap(t_vars *data)
{
	...
	mini.dst_x = 50 - data->player.x;
	mini.dst_y = 50 - data->player.y;
	mini.posx = floor(data->player.x / data->data.cub_size) * data->data.cub_size;
	mini.posy = floor(data->player.y / data->data.cub_size) * data->data.cub_size;
	
	printf("[%d][%d] [%d][%d]\n", mini.posx, mini.posy, mini.dst_x, mini.dst_y);
